...
2의 보수법
  ...
  sign = 맨앞에 절대부호를 붙여 0 = 양수 1 = 음수로 설정하여 계산한다.
  단점으로는 빼기 수식을 수행할 수 없다.
  1의 보수 = 음수의 경우 양수의 신호를 뒤집어 표현한다. 빼기 수식을 할 경우 오른쪽 끝에 1을 더한 후 뺀다.
  2의 보수 = 음수의 경우 양수의 신호를 뒤집어 표현한뒤 오른쪽 끝에 1을 미리 더한다. 그래서 빼기대신 그냥 더하면된다
