...
@RestController("lang.varable.exam3")// 클래스 이름이 같은 경우 충돌 방지
@RequestMapping("/lang/variable/exam3")
public class Exam3 {

  //스프링 부트는 클라이언트가 보낸 값을 파라미터 타입에 맞춰 자동 형변환을 수행한다.
  //테스트 URL:
  //=> http://localhost:8080/lang/variable/exam3/test1?b=100&s=200&i=654321&l=9876543219876&f=3.14&d=345.678&bool=true&c=가
  @GetMapping("/test1")
